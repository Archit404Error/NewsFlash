...
def get_news(sources, topic):
    ...
    articles.sort(
        key=lambda item: dateutil.parser.parse(item["publishedAt"]).timestamp() * -1
    )
        ...
        if len(articles) == 0:
            ...
            return {
                "No Source Found": [
                    "http://127.0.0.1:5000",
                    "No article found",
                    "No recent news on the topic of " + topic,
                    "https://upload.wikimedia.org/wikipedia/commons/thumb/4/46/Question_mark_%28black%29.svg/1200px-Question_mark_%28black%29.svg.png",
                ]
            }
        ...
        if article_from_id_exists == False:
            ...
            try:
                ...
                parsed_articles[source_id] = [
                    ...
                    "The source prevented automatic article summarization, but the full article can still be read via the link.",
                    "https://upload.wikimedia.org/wikipedia/commons/thumb/4/46/Question_mark_%28black%29.svg/1200px-Question_mark_%28black%29.svg.png",
                ]
